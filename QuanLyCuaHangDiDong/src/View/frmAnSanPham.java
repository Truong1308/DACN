...
public class frmAnSanPham extends javax.swing.JFrame 
{
    ...
    private void initComponents() {
        ...
        jLabel2.setText("HÃY LỰA CHỌN 1 TRONG 2 PHƯƠNG THỨC");
    ...
    private void btnAnSanPhamActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAnSanPhamActionPerformed
        ...
        String cautruyvan = "update SanPham set TrangThai= " + TrangThai + " where MaSanPham= " + MaSanPham;
        System.out.println(cautruyvan);
        boolean kiemtra = true;
        if (kiemtra) 
        {
            cnn.ExcuteQueryUpdateDB(cautruyvan);            
            sp.ThongBao("Thay đổi thành công", "Thông báo", 2);
       ...
       if(!temp.equals(""))
        {
            ...
            sp.ThongBao("bạn chưa nhập mã sản phẩm", "lỗi khi xóa",2);
